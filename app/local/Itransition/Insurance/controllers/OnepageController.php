...
class Itransition_Insurance_OnepageController extends Mage_Checkout_OnepageController
{
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!$result) {
                ...
                if (Mage::helper('insurance')->isEnabled()) {
                    $this->loadLayout('checkout_onepage_insurance');
    ...
    public function saveInsuranceAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $insuranceResult = $this->getRequest()->getPost('insurance',false);
            $this->getOnepage()->getCheckout()->setData('isSelectedInsurance', $insuranceResult);
    ...
    public function saveOrderAction()
    {
        ...
        $this->getOnepage()->getCheckout()->unsetData('isSelectedInsurance');
        $this->getResponse()->setBody(Mage::helper('core')->jsonEncode($result));
    }
